...
class WalletScreen:
    def __init__(self, parent_window):
        ...
        print("✅ Wallet Screen opened")
    
    def load_images(self):
        """Load wallet screen images"""
        ...
        try:
            ...
            print(f"Error loading wallet images: {e}")
    ...
    def setup_ui(self):
        ...
        # Available Balance Card - ENHANCED with rounded corners
    ...
    def create_transaction_list(self):
        """Create scrollable transaction history list"""
    ...
    def populate_transactions(self):
        """Populate transaction history items"""
        for transaction in self.transaction_history:
            self.create_transaction_item(transaction)
    
    def create_transaction_item(self, transaction):
        """Create a single transaction item with modern rounded design"""
        # Container canvas for rounded rectangle
        item_canvas = Canvas(
        ...
        # Border color (blue for deposit, red for withdraw)
        ...
        # Amount (green for deposit, red for withdraw)
    ...
    def show_add_money_dialog(self):
        ...
        # Quick amount buttons with modern design
        tk.Label(
        ...
        # Confirm button with modern rounded design
        def confirm_add():
            try:
        ...
        # Draw rounded button with shadow
        self.create_rounded_rect_on_canvas(
