...
PAGE_IMAGES = [
    ...
    "Sign Up.png",
    "home.png",
    "forgot password frame.png"  # Added forgot password image
]
...
BUTTON_IMAGES = {
    ...
    'forgot_password': ("Forgot Password Button.png", (150, 40)),
...
PAGE_SIGNUP = 6
PAGE_HOME = 7
PAGE_FORGOT_PASSWORD = 8  # Now matches the index in PAGE_IMAGES
